...
export MODEL_BUCKET_PROD="stg-credit-profile"
export PREDICTIONS_STREAM_NAME="stg_credit_profile_predictions-credit_card_profile_prediction"
export LAMBDA_FUNCTION="stg_profile_lambda_credit_card_profile_prediction"

# Model artifacts bucket from the previous weeks (MLflow experiments)
export MODEL_BUCKET_DEV="jai-mlops-data"
...
export RUN_ID='96a17ab73a2645a2b7ecfeb4ef7cd6cd'
